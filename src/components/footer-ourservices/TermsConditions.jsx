    ...
    <section className="bg-gray-100 min-h-screen py-16 px-6 md:px-16">
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-10 bg-white rounded-3xl shadow-xl overflow-hidden">
        ...
        <div className="md:col-span-3 p-10">
          ...
          <p className="text-gray-600 mb-10 text-2xl font-semibold">
          ...
          {/* Section 2 */}
          <div id="usage" className="mb-10">
            <h2 className="text-3xl font-semibold text-[#B33F18] mb-3">
              2. Website Usage
            </h2>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 text-xl font-medium">
          ...
          {/* Section 6 */}
          <div id="liability" className="mb-10">
            <h2 className="text-3xl font-semibold text-[#B33F18] mb-3">
          ...
          {/* Section 8 */}
          <div id="termination" className="mb-10">
            <h2 className="text-3xl font-semibold text-[#B33F18] mb-3">
              8. Termination
            </h2>
            <p className="text-gray-700 leading-relaxed text-xl font-medium">
