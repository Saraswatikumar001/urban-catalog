      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative flex justify-center">
         ...
         />         
          ...
          {/* Experience Badge */}
          <div className="absolute bottom-[123px] left-[11px] -translate-x-1/2 bg-orange-500 text-white w-33 h-33 rounded-full flex flex-col items-center justify-center shadow-lg">
